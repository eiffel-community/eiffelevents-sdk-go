...
type CLMV1Data struct {
	...
	// Optional fields
	CustomData []CLMV1DataCustomDatum `json:"customData,omitempty"`
	Issuer     CLMV1DataIssuer        `json:"issuer,omitempty"`
}

type CLMV1DataCustomDatum struct {
	// Mandatory fields
	Key   string      `json:"key"`
...
type CLMV1Meta struct {
	...
	// Optional fields
	Security CLMV1MetaSecurity `json:"security,omitempty"`
	Source   CLMV1MetaSource   `json:"source,omitempty"`
	Tags     []string          `json:"tags,omitempty"`
}

type CLMV1MetaSecurity struct {
	// Mandatory fields

	// Optional fields
	SDM CLMV1MetaSecuritySDM `json:"sdm,omitempty"`
}

type CLMV1MetaSecuritySDM struct {
	// Mandatory fields
...
type CLMV1MetaSource struct {
	...
	Name       string                    `json:"name,omitempty"`
	Serializer CLMV1MetaSourceSerializer `json:"serializer,omitempty"`
	URI        string                    `json:"uri,omitempty"`
}

type CLMV1MetaSourceSerializer struct {
	// Mandatory fields

...
var eventTypeTable = map[string]map[int64]majorEventVersion{
	"EiffelActivityCanceledEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ActivityCanceledV3{}), "3.1.0"},
	},
	"EiffelActivityFinishedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ActivityFinishedV3{}), "3.2.0"},
	},
	"EiffelActivityStartedEvent": {
		...
		4: majorEventVersion{reflect.TypeOf(ActivityStartedV4{}), "4.2.0"},
	},
	"EiffelActivityTriggeredEvent": {
		...
		4: majorEventVersion{reflect.TypeOf(ActivityTriggeredV4{}), "4.1.0"},
	},
	"EiffelAnnouncementPublishedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(AnnouncementPublishedV3{}), "3.1.0"},
	},
	"EiffelArtifactCreatedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ArtifactCreatedV3{}), "3.1.0"},
	},
	"EiffelArtifactPublishedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ArtifactPublishedV3{}), "3.2.0"},
	},
	"EiffelArtifactReusedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ArtifactReusedV3{}), "3.1.0"},
	},
	"EiffelCompositionDefinedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(CompositionDefinedV3{}), "3.2.0"},
	},
	"EiffelConfidenceLevelModifiedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(ConfidenceLevelModifiedV3{}), "3.1.0"},
	},
	"EiffelEnvironmentDefinedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(EnvironmentDefinedV3{}), "3.2.0"},
	},
	"EiffelFlowContextDefinedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(FlowContextDefinedV3{}), "3.1.0"},
	},
	"EiffelIssueDefinedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(IssueDefinedV3{}), "3.1.0"},
	},
	"EiffelIssueVerifiedEvent": {
		...
		4: majorEventVersion{reflect.TypeOf(IssueVerifiedV4{}), "4.1.0"},
	},
	"EiffelSourceChangeCreatedEvent": {
		...
		4: majorEventVersion{reflect.TypeOf(SourceChangeCreatedV4{}), "4.1.0"},
	},
	"EiffelSourceChangeSubmittedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(SourceChangeSubmittedV3{}), "3.1.0"},
	},
	"EiffelTestCaseCanceledEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestCaseCanceledV3{}), "3.1.0"},
	},
	"EiffelTestCaseFinishedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestCaseFinishedV3{}), "3.2.0"},
	},
	"EiffelTestCaseStartedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestCaseStartedV3{}), "3.2.0"},
	},
	"EiffelTestCaseTriggeredEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestCaseTriggeredV3{}), "3.1.0"},
	},
	...
	"EiffelTestSuiteFinishedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestSuiteFinishedV3{}), "3.2.0"},
	},
	"EiffelTestSuiteStartedEvent": {
		...
		3: majorEventVersion{reflect.TypeOf(TestSuiteStartedV3{}), "3.2.0"},
	},
}

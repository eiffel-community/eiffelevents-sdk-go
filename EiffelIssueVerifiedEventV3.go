...
// NewIssueVerifiedV3 creates a new struct pointer that represents
// major version 3 of EiffelIssueVerifiedEvent.
...
type IVV3Data struct {
	...
	// Optional fields
	CustomData []IVV3DataCustomDatum `json:"customData,omitempty"`
}

type IVV3DataCustomDatum struct {
	// Mandatory fields
	Key   string      `json:"key"`
...
type IVV3Meta struct {
	...
	// Optional fields
	Security IVV3MetaSecurity `json:"security,omitempty"`
	Source   IVV3MetaSource   `json:"source,omitempty"`
	Tags     []string         `json:"tags,omitempty"`
}

type IVV3MetaSecurity struct {
	// Mandatory fields

	// Optional fields
	SDM IVV3MetaSecuritySDM `json:"sdm,omitempty"`
}

type IVV3MetaSecuritySDM struct {
	// Mandatory fields

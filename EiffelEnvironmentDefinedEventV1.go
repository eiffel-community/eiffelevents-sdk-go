...
// NewEnvironmentDefinedV1 creates a new struct pointer that represents
// major version 1 of EiffelEnvironmentDefinedEvent.
...
type EDV1Data struct {
	...
	// Optional fields
	CustomData []EDV1DataCustomDatum `json:"customData,omitempty"`
...
type EDV1DataCustomDatum struct {
	// Mandatory fields
	Key   string      `json:"key"`
...
type EDV1Meta struct {
	...
	// Optional fields
	Security EDV1MetaSecurity `json:"security,omitempty"`
	Source   EDV1MetaSource   `json:"source,omitempty"`
	Tags     []string         `json:"tags,omitempty"`
}

type EDV1MetaSecurity struct {
	// Mandatory fields

	// Optional fields
	SDM EDV1MetaSecuritySDM `json:"sdm,omitempty"`
}

type EDV1MetaSecuritySDM struct {
	// Mandatory fields
...
type EDV1MetaSource struct {
	...
	Serializer EDV1MetaSourceSerializer `json:"serializer,omitempty"`
	URI        string                   `json:"uri,omitempty"`
}

type EDV1MetaSourceSerializer struct {
	// Mandatory fields
